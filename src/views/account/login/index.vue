<template>
	<div class="login-con main">
		...
		<Row class="main-box">
			<img src="https://img2.zhidianlife.com/image/2021/01/11/36f3c045-0a4c-4ab9-9e91-725325deadfc.jpeg" class="bg"/>
			<Card :bordered="false" class="login-box">
				<div slot="title" class="register">
					<span class="register-title">用户登录</span>
					<Button style="float:right" size="small" @click="enter"
					        class="register-btn">注册新用户
					</Button>
				</div>
				<div class="form-con">
