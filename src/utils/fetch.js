...
const addErrorLog = errorInfo => {
    ...
    if (!responseURL.includes('save_error_logger_url')) store.dispatch('addErrorLog', info)
}
...
class HttpRequest {
    ...
    interceptors (instance, url) {
        ...
        instance.interceptors.response.use(res => {
            ...
            const isType=headers['content-type']=='application/vnd.ms-excel;charset=utf-8'//判断请求类型
